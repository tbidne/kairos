...
Once you have `cabal` and `ghc`, `kairos` can be built with `cabal build kairos-exe` or installed globally (i.e. `~/.local/bin/kairos`) with `cabal install kairos-exe`.
...
Once you have `stack`, `kairos` can be built with `stack build kairos-exe` or installed globally (i.e. `~/.local/bin/kairos`) with `stack install kairos-exe`.
